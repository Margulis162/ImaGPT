...
const Loader = () => (
    <div role="status">
    <svg aria-hidden="true" className="inline w-20 h-20 mr-2 text-gray-200 fill-[#ffab19]" viewBox="0 0 100 101" fill="none" svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
<g>

    <circle cx="60" cy="50" r="4" fill="#ff4e98">
    ...
    <circle cx="60" cy="50" r="4" fill="#8639fa">
    ...
    <circle cx="60" cy="50" r="4" fill="#33f6f0">
...
<g transform="translate(-15 0)">
    ...
    <animate attributeName="fill" from="cyan" to="hotpink" dur="2s" repeatCount="indefinite" />values="0 50 50;-45 50 50;0 50 50" keyTimes="0;0.5;1"/
    </path>
</g>
</svg>
</div>
